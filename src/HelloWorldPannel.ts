...
export class HellowWorldPannel {
  /**
   * Track the currently panel. Only allow a single panel to exist at a time.
   */
  public static currentPanel: HellowWorldPannel | undefined;
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (HellowWorldPannel.currentPanel) {
      HellowWorldPannel.currentPanel._panel.reveal(column);
      HellowWorldPannel.currentPanel._update();
      return;
    }

    // Otherwise, create a new panel.
    const panel = vscode.window.createWebviewPanel(
      HellowWorldPannel.viewType,
      "VSinder",
    ...
    HellowWorldPannel.currentPanel = new HellowWorldPannel(panel, extensionUri);
  }

  public static kill() {
    HellowWorldPannel.currentPanel?.dispose();
    HellowWorldPannel.currentPanel = undefined;
  }
